...
class NewsService:
    ...
    def _is_sports_news(article: Dict[str, Any]) -> bool:
        ...
        primary_sports_keywords = [
            ...
            "ขนไก่", "ซัดขนไก่", "ประเดิมขนไก่", "เชือดคู่", "ศึกขนไก่",
            "เอ็ม-มุก", "มุก-เอ็ม", "แบดเยอรมัน", "เยอรมันโอเพ่น",
            "german open", "ฝรั่งเศสโอเพ่น", "french open", "เกาหลีโอเพ่น",
            "japan open", "ไทยแลนด์โอเพ่น", "thailand open", "indonesia open",
            # Tennis specific
